...
- 🎯 Entry points to execute your program using `python -m <scdataloader>` or `$ scdataloader` with basic CLI argument parsing.
...
Awesome scdataloader created by jkobject
...
```py
from scdataloader import BaseClass
from scdataloader import base_function
